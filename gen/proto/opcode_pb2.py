...
_OPCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='OpResult_LevelSprint_Have_DrawTimes', index=22, number=304,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='OpResult_LevelSprint_No_DrawTimes', index=23, number=305,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
OpResult_LevelSprint_Have_DrawTimes = 304
OpResult_LevelSprint_No_DrawTimes = 305
